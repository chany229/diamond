...
class Admin::EntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_entry" do
    assert_difference('Admin::Entry.count') do
      post admin_entries_url, params: { admin_entry: { body: @admin_entry.body, category_id: @admin_entry.category_id, title: @admin_entry.title, user_id: @admin_entry.user_id } }
    end
  ...
  test "should update admin_entry" do
    patch admin_entry_url(@admin_entry), params: { admin_entry: { body: @admin_entry.body, category_id: @admin_entry.category_id, title: @admin_entry.title, user_id: @admin_entry.user_id } }
